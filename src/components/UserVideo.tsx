...
const UserVideo = ({ username, avatarUrl, isCurrentUser = false, isMuted = false }: UserVideoProps) => {
  ...
  return (
    <div className="video-container group animate-scale-in">
      {/* Video placeholder */}
      ...
      <div 
        className={`absolute inset-0 ${videoLoaded ? 'opacity-100' : 'opacity-0'} transition-opacity duration-700`}
        style={{ 
